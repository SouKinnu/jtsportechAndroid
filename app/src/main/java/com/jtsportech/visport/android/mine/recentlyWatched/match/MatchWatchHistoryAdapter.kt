 ...
 */
class MatchWatchHistoryAdapter :
    BaseListAdapter<Competition, ItemCompetitionBinding>(MatchWatchHistoryDiffCallback()) {
    ...
    class MatchWatchHistoryDiffCallback : DiffUtil.ItemCallback<Competition>() {
