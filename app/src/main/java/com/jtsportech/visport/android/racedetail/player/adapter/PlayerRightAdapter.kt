...
import com.jtsportech.visport.android.databinding.ItemPlayerList2Binding
import com.jtsportech.visport.android.utils.img

class PlayerRightAdapter :
    BaseListAdapter<Team1Player, ItemPlayerList2Binding>(EventDataDiffCallback()) {
    ...
    override fun createBinding(
        ...
        parent: ViewGroup
    ): ItemPlayerList2Binding {
        return ItemPlayerList2Binding.inflate(inflater, parent, false)
    }

    override fun bind(binding: ItemPlayerList2Binding, item: Team1Player, position: Int) {
