...
import com.cloudhearing.android.lib_common.image.core.ImageOptions.DrawableOptions.Companion.DEFAULT
import com.cloudhearing.android.lib_common.image.core.OnImageListener
import com.cloudhearing.android.lib_common.image.progress.OnProgressListener
...
fun ImageView.loadImage(
    ...
    this.loadImage(
        load = url, placeHolderResId = placeHolder, errorResId = errorId,
...
fun ImageView.loadProgressImage(
    ...
    this.loadImage(
        load = url, placeHolderResId = placeHolder, errorResId = placeHolder,
