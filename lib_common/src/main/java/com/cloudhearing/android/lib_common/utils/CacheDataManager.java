...
public class CacheDataManager {
     ...
     * @throws Exception
     */
    public static String getTotalCacheSizeWithUnit(Context context) throws Exception {
    ...
    public static long getTotalCacheSize(Context context) throws Exception {
        long cacheSize = getFolderSize(context.getCacheDir()); // /data/user/0/com.ruijin.android.rainbow/cache
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            cacheSize += getFolderSize(context.getExternalCacheDir());
