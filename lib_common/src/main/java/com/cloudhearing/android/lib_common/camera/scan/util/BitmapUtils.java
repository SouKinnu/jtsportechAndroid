package com.cloudhearing.android.lib_common.camera.scan.util;
...
import com.cloudhearing.android.lib_common.camera.scan.FrameMetadata;
...
public class BitmapUtils {
    ...
    public static Bitmap getBitmap(byte[] nv21Data, FrameMetadata frameMetadata) {
        return getBitmap(ByteBuffer.wrap(nv21Data), frameMetadata.getWidth(), frameMetadata.getHeight(), frameMetadata.getRotation());
    }
    ...
    public static Bitmap getBitmap(ImageProxy image) {
        ...
        byte[] nv21Data = yuv420ThreePlanesToNV21(image.getImage().getPlanes(), image.getWidth(), image.getHeight());
        return getBitmap(ByteBuffer.wrap(nv21Data), image.getWidth(), image.getHeight(), image.getImageInfo().getRotationDegrees());
    }
