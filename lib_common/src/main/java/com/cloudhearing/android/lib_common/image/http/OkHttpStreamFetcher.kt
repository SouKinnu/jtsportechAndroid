package com.cloudhearing.android.lib_common.image.http
 ...
 */
class OkHttpStreamFetcher (private val client: okhttp3.Call.Factory, private val url: GlideUrl) : DataFetcher<InputStream>,
    Callback {
